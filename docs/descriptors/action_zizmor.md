...
- Enable zizmor by adding `ACTION_ZIZMOR` in [ENABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
- Disable zizmor by adding `ACTION_ZIZMOR` in [DISABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)

- Enable **autofixes** by adding `ACTION_ZIZMOR` in [APPLY_FIXES variable](https://megalinter.io/9.5.0/configuration/#apply-fixes)
