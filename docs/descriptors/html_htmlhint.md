...
- Enable htmlhint by adding `HTML_HTMLHINT` in [ENABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
- Disable htmlhint by adding `HTML_HTMLHINT` in [DISABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
...
- NPM packages (node.js):
  - [htmlhint@1.9.2](https://www.npmjs.com/package/htmlhint/v/1.9.2)
