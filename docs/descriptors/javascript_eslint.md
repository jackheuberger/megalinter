...
- Enable eslint by adding `JAVASCRIPT_ES` in [ENABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
- Disable eslint by adding `JAVASCRIPT_ES` in [DISABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)

- Enable **autofixes** by adding `JAVASCRIPT_ES` in [APPLY_FIXES variable](https://megalinter.io/9.5.0/configuration/#apply-fixes)
