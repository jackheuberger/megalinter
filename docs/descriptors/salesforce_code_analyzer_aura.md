...
- Enable code-analyzer-aura by adding `SALESFORCE_CODE_ANALYZER_AURA` in [ENABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
- Disable code-analyzer-aura by adding `SALESFORCE_CODE_ANALYZER_AURA` in [DISABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
