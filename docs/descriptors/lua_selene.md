...
- Enable selene by adding `LUA_SELENE` in [ENABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
- Disable selene by adding `LUA_SELENE` in [DISABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
...
- Cargo packages (Rust):
  - [selene](https://crates.io/crates/selene)
