...
<div align="center">
  <a href="https://github.com/kucherenko/jscpd/tree/master/apps/jscpd#readme" target="blank" title="Visit linter Web Site">
...
- Enable jscpd by adding `COPYPASTE_JSCPD` in [ENABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
- Disable jscpd by adding `COPYPASTE_JSCPD` in [DISABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
