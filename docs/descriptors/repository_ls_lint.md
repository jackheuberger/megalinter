...
- Enable ls-lint by adding `REPOSITORY_LS_LINT` in [ENABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
- Disable ls-lint by adding `REPOSITORY_LS_LINT` in [DISABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
