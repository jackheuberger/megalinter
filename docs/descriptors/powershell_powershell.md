...
- Enable powershell by adding `POWERSHELL_POWERSHELL` in [ENABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
- Disable powershell by adding `POWERSHELL_POWERSHELL` in [DISABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)

- Enable **autofixes** by adding `POWERSHELL_POWERSHELL` in [APPLY_FIXES variable](https://megalinter.io/9.5.0/configuration/#apply-fixes)
