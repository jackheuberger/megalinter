...
- Visit [Official Web Site](https://github.com/Flow-Scanner/lightning-flow-scanner-cli#readme){target=_blank}
...
[![lightning-flow-scanner-cli - GitHub](https://gh-card.dev/repos/Flow-Scanner/lightning-flow-scanner-cli.svg?fullname=)](https://github.com/Flow-Scanner/lightning-flow-scanner-cli){target=_blank}

## Configuration in MegaLinter

- Enable lightning-flow-scanner by adding `SALESFORCE_LIGHTNING_FLOW_SCANNER` in [ENABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
- Disable lightning-flow-scanner by adding `SALESFORCE_LIGHTNING_FLOW_SCANNER` in [DISABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
...
ARG LIGHTNING_FLOW_SCANNER_VERSION=6.19.3
