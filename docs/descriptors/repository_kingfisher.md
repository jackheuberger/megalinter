...
- Enable kingfisher by adding `REPOSITORY_KINGFISHER` in [ENABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
- Disable kingfisher by adding `REPOSITORY_KINGFISHER` in [DISABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
