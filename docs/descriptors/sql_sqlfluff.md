...
- Enable sqlfluff by adding `SQL_SQLFLUFF` in [ENABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
- Disable sqlfluff by adding `SQL_SQLFLUFF` in [DISABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)

- Enable **autofixes** by adding `SQL_SQLFLUFF` in [APPLY_FIXES variable](https://megalinter.io/9.5.0/configuration/#apply-fixes)
