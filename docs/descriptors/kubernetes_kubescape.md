...
- Enable kubescape by adding `KUBERNETES_KUBESCAPE` in [ENABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
- Disable kubescape by adding `KUBERNETES_KUBESCAPE` in [DISABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
