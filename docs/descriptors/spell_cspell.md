...
- Enable cspell by adding `SPELL_CSPELL` in [ENABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
- Disable cspell by adding `SPELL_CSPELL` in [DISABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
...
- NPM packages (node.js):
  - [cspell@10.0.0](https://www.npmjs.com/package/cspell/v/10.0.0)
