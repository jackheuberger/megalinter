...
- Enable shellcheck by adding `BASH_SHELLCHECK` in [ENABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
- Disable shellcheck by adding `BASH_SHELLCHECK` in [DISABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
...
```shell
shellcheck --color=auto --external-sources --rcfile=.shellcheckrc myfile.sh
```
