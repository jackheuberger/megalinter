...
- Enable ruff-format by adding `PYTHON_RUFF_FORMAT` in [ENABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
- Disable ruff-format by adding `PYTHON_RUFF_FORMAT` in [DISABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
