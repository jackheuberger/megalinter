...
- Enable puppet-lint by adding `PUPPET_PUPPET_LINT` in [ENABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
- Disable puppet-lint by adding `PUPPET_PUPPET_LINT` in [DISABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)

- Enable **autofixes** by adding `PUPPET_PUPPET_LINT` in [APPLY_FIXES variable](https://megalinter.io/9.5.0/configuration/#apply-fixes)
...
ARG GEM_PUPPET_LINT_VERSION=5.1.1
```
