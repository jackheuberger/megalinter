...
- Enable rumdl by adding `MARKDOWN_RUMDL` in [ENABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
- Disable rumdl by adding `MARKDOWN_RUMDL` in [DISABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)

- Enable **autofixes** by adding `MARKDOWN_RUMDL` in [APPLY_FIXES variable](https://megalinter.io/9.5.0/configuration/#apply-fixes)
...
- PIP packages (Python):
  - [rumdl==0.1.93](https://pypi.org/project/rumdl/0.1.93)
