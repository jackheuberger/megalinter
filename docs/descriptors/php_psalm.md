...
- Version in MegaLinter: **Psalm.6.16.1@**
...
- Enable psalm by adding `PHP_PSALM` in [ENABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
- Disable psalm by adding `PHP_PSALM` in [DISABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
