...
- Enable v8r by adding `JSON_V8R` in [ENABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
- Disable v8r by adding `JSON_V8R` in [DISABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
...
| JSON_V8R_CONFIG_FILE                 | v8r configuration file name</br>Use `LINTER_DEFAULT` to let the linter find it                                                                                                                                      | `.v8rrc.yml`                                    |
| JSON_V8R_RULES_PATH                  | Path where to find linter configuration file                                                                                                                                                                        | Workspace folder, then MegaLinter default rules |
