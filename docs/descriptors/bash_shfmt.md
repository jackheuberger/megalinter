...
- Enable shfmt by adding `BASH_SHFMT` in [ENABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
- Disable shfmt by adding `BASH_SHFMT` in [DISABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)

- Enable **autofixes** by adding `BASH_SHFMT` in [APPLY_FIXES variable](https://megalinter.io/9.5.0/configuration/#apply-fixes)
