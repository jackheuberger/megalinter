...
- Enable ansible-lint by adding `ANSIBLE_ANSIBLE_LINT` in [ENABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
- Disable ansible-lint by adding `ANSIBLE_ANSIBLE_LINT` in [DISABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
...
options:
  ...
  -r, --rules-dir RULESDIR
                        Specify custom rule directories. Add -R to keep using embedded rules from /venvs/ansible-lint/lib/python3.14/site-packages/ansiblelint/rules
