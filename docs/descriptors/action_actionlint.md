...
- Enable actionlint by adding `ACTION_ACTIONLINT` in [ENABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
- Disable actionlint by adding `ACTION_ACTIONLINT` in [DISABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
...
Documents:
  ...
  - List of checks: https://github.com/rhysd/actionlint/tree/v1.7.12/docs/checks.md
  - Usage:          https://github.com/rhysd/actionlint/tree/v1.7.12/docs/usage.md
  - Configuration:  https://github.com/rhysd/actionlint/tree/v1.7.12/docs/config.md
