...
- Enable isort by adding `PYTHON_ISORT` in [ENABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
- Disable isort by adding `PYTHON_ISORT` in [DISABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)

- Enable **autofixes** by adding `PYTHON_ISORT` in [APPLY_FIXES variable](https://megalinter.io/9.5.0/configuration/#apply-fixes)
...
- File extensions: `.py`, `.pyi`, `.pyx`, `.pxd`
...
usage: isort [-h] [-V] [--vn] [-v] [--only-modified] [--dedup-headings] [-q]
             ...
             [-n] [--nis | --sl] [--ot] [--dt] [--rr] [--reverse-sort]
             [--sort-order SORT_ORDER] [--nsl SINGLE_LINE_EXCLUSIONS] [--tc]
             [--up] [-l LINE_LENGTH] [--wl WRAP_LENGTH] [--case-sensitive]
...
section output options:
  ...
  --py, --python-version {all,2,27,3,310,311,312,313,314,36,37,38,39,auto}
                        ...
                        isort (currently: 314) will be used.
```
