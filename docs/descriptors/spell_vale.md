...
- Enable vale by adding `SPELL_VALE` in [ENABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
- Disable vale by adding `SPELL_VALE` in [DISABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
...
Flags:
 ...
 --path           A file path to associate with stdin (--path=docs/example.md).
