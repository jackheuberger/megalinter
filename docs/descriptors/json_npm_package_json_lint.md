...
- Enable npm-package-json-lint by adding `JSON_NPM_PACKAGE_JSON_LINT` in [ENABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
- Disable npm-package-json-lint by adding `JSON_NPM_PACKAGE_JSON_LINT` in [DISABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
...
- NPM packages (node.js):
  - [npm-package-json-lint@10.4.0](https://www.npmjs.com/package/npm-package-json-lint/v/10.4.0)
  - [npm-package-json-lint-config-default@9.0.1](https://www.npmjs.com/package/npm-package-json-lint-config-default/v/9.0.1)
