...
- Enable ktlint by adding `KOTLIN_KTLINT` in [ENABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
- Disable ktlint by adding `KOTLIN_KTLINT` in [DISABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)

- Enable **autofixes** by adding `KOTLIN_KTLINT` in [APPLY_FIXES variable](https://megalinter.io/9.5.0/configuration/#apply-fixes)
