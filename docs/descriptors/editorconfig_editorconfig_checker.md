...
- Enable editorconfig-checker by adding `EDITORCONFIG_EDITORCONFIG_CHECKER` in [ENABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
- Disable editorconfig-checker by adding `EDITORCONFIG_EDITORCONFIG_CHECKER` in [DISABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
...
| EDITORCONFIG_EDITORCONFIG_CHECKER_CONFIG_FILE                 | editorconfig-checker configuration file name</br>Use `LINTER_DEFAULT` to let the linter find it                                                                                                                     | `.editorconfig-checker.json`                    |
