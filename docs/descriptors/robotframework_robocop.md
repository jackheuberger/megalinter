...
- Enable robocop by adding `ROBOTFRAMEWORK_ROBOCOP` in [ENABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
- Disable robocop by adding `ROBOTFRAMEWORK_ROBOCOP` in [DISABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)

- Enable **autofixes** by adding `ROBOTFRAMEWORK_ROBOCOP` in [APPLY_FIXES variable](https://megalinter.io/9.5.0/configuration/#apply-fixes)
