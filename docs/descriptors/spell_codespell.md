...
- Enable codespell by adding `SPELL_CODESPELL` in [ENABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
- Disable codespell by adding `SPELL_CODESPELL` in [DISABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)

- Enable **autofixes** by adding `SPELL_CODESPELL` in [APPLY_FIXES variable](https://megalinter.io/9.5.0/configuration/#apply-fixes)
