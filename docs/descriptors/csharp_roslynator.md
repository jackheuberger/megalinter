...
- Enable roslynator by adding `CSHARP_ROSLYNATOR` in [ENABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
- Disable roslynator by adding `CSHARP_ROSLYNATOR` in [DISABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)

- Enable **autofixes** by adding `CSHARP_ROSLYNATOR` in [APPLY_FIXES variable](https://megalinter.io/9.5.0/configuration/#apply-fixes)
