...
- Enable trivy-sbom by adding `REPOSITORY_TRIVY_SBOM` in [ENABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
- Disable trivy-sbom by adding `REPOSITORY_TRIVY_SBOM` in [DISABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
