...
- Enable checkov by adding `REPOSITORY_CHECKOV` in [ENABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
- Disable checkov by adding `REPOSITORY_CHECKOV` in [DISABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
...
options:
  ...
  --prisma-api-url PRISMA_API_URL
                        ...
                        https://prisma.pan.dev/api/cloud/api-urls). Must be a
                        *.prismacloud.io, *.prismacloud.cn, or
                        *.bridgecrew.cloud domain. Requires --bc-api-key to be
                        a Prisma Cloud Access Key in the following format:
                        <access_key_id>::<secret_key> [env var:
                        PRISMA_API_URL]
  --skip-results-upload
...
- PIP packages (Python):
  - [checkov==3.2.529](https://pypi.org/project/checkov/3.2.529)
