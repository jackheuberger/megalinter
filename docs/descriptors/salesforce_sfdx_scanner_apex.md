...
>
> sfdx-scanner has been deprecated by Salesforce and will be soon be removed from MegaLinter. Please use SALESFORCE_CODE_ANALYZER_APEX instead.
>
> You should disable sfdx-scanner-apex by adding it in DISABLE_LINTERS property.
>
...
- Enable sfdx-scanner-apex by adding `SALESFORCE_SFDX_SCANNER_APEX` in [ENABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
- Disable sfdx-scanner-apex by adding `SALESFORCE_SFDX_SCANNER_APEX` in [DISABLE_LINTERS variable](https://megalinter.io/9.5.0/configuration/#activation-and-deactivation)
